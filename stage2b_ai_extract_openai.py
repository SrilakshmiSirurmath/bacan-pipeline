...
supplier_name: extract from (2.b) Nome dello speditore. Capture the entire value after this label, 
including spaces and punctuation, until the next numbered field (e.g., “(2.c)”, “(3.)”, “(4.)”) or a new section header. Do not shorten or paraphrase.
